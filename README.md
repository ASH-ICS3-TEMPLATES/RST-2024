[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/tYw6S_Rv)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17549297)
# Gr. 11 Final Project (RST)

### 2024-25 Edition

###### ICS3UC - Mr. J 🐠

`This is your Final Project (Rich Summative Task)`  
**`It is worth 30% of the overall mark`.**

**Note:** The code files have only been slightly setup.
...
- Timeline
- [Step 1:](#step-1-proposal-pick-a-game-or-app) Proposal
- [Step 2:](#step-2-draft-gui-storyboard) Draft GUI
- [Step 3:](#step-3-code-planning---more-drafts) Code Planning
- [Step 4:](#step-4-coding) Coding!
- [Step 5:](#step-5-testing) Testing (crucial!)
- [SUBMIT!](#submit)
- [Game Ideas](#game-selection)
- [Rubric](#rubric-suggestions)
- [Hangman Database](#using-mr-brashs-hangman-database)
...
Decide what you'd like to build. [Click here to submit your proposal](https://forms.gle/29GaH8NjH3YZcMkw9).

### Step 2: Draft GUI (storyboard)
Either on paper, a whiteboard, or with digital drawing tools create a _somewhat detailed_ design for the front-end of your program. This should include any and all input from the user as well as extra pages or information panels. _Being detailed here will save you time in the future._ **It is a good idea to put your draft GUI images inside the _drafts_ folder of the repository.

**Tip:** You could install the [Excalidraw extension](vscode:extension/pomdtr.excalidraw-editor) to include drawings directly in your repository!

### Step 3: Code Planning - More drafts!

Now that you have a plan for the front-end, you can begin designing the data structure and functional structure for your program.
- What sort of data structure (variables) will you need:
...
**Tip:** This planning can _also_ go in the drafts folder - a safe place to keep stuff.
...
3. Write the functions one-by-one, testing as necessary. Keep notes on changes you foresee or extra functions and algorithms you did not realize you would need during your planning stages. 
...
### Using Mr. J's Friends 🐿️ Hangman Database
...
If you would like a new category or entry added, contact Mr. J.
